...
import { createSnippetsRegistry } from '@emmetio/expand-abbreviation';
...
function getSnippetsCompletions(editor, prefix) {
	...
	const completions = completionsCache.get(syntax)
	.filter(completion => completion.text.indexOf(prefix) === 0)
	.map(completion => Object.assign({ replacementPrefix: prefix }, completion));
