...
export default function(selector) {
	return {
		...
		getSuggestions({editor, bufferPosition, prefix, activatedManually}) {
			...
			// add Emmet snippets completions for given prefix. If no prefix,
			// add completions only if activated manually
			return (prefix && hasAutoActivateContext(editor)) || activatedManually
				? result.concat(getSnippetsCompletions(editor, prefix))
				: null;
		},
